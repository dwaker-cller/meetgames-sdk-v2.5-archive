...
Each of the 16 delivery ZIP files was compared with its same-named extracted directory. File paths, file counts, sizes, and per-file SHA-256 values matched for all 16 pairs.
