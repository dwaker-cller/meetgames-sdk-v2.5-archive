(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push([ "object" == typeof document ? document.currentScript : void 0, 22035, e => {
    ...
    if ("object" == typeof document && !document.getElementById("mgp-sdk-card-redesign-styles")) {
        ...
        e.id = "mgp-sdk-card-redesign-styles", e.rel = "stylesheet", e.href = "./demo-sdk-card-redesign.css?v=20260805-feedback-9", 
    ...
    let R = [ {
        ...
        title: "发行渠道",
        short: "发行渠道",
        description: "配置当前游戏计划发行的平台、发行渠道及渠道支付参数。",
        icon: v.Globe2,
        ...
        title: "登录方式",
        short: "登录方式",
        description: "维护游戏可用的聚合登录方式及对应平台参数。",
        icon: $.LogIn,
        ...
        title: "协议配置",
        short: "协议",
        description: "维护隐私政策、用户协议、儿童隐私与协议弹窗策略。",
        icon: b.FileCheck2
    }, {
        id: "compliance",
        title: "合规配置",
        short: "合规",
        description: "配置年龄、KWS 验证与游客保护参数。",
        icon: P.ShieldCheck,
        ...
        title: "三方数据配置",
        short: "三方数据",
        description: "选择 Firebase、AppsFlyer、Adjust 并填写接入参数。",
        icon: g.Database,
        ...
        title: "广告变现",
        short: "广告变现",
        description: "所有发行渠道共用这一套广告变现配置，无需按渠道重复维护。",
        icon: r.BarChart3,
        ...
        title: "客服配置",
        short: "客服",
        description: "统一配置在线客服、表单反馈、FAQ 与智能客服。",
        icon: N.Headphones
    } ], G = [ {
        id: "guest",
        code: "GUEST",
    ...
    let er = [ "消除", "益智", "超休闲", "动作", "博弈", "运动", "策略", "派对", "桌面游戏", "儿童类", "其他", "赛车", "角色扮演", "射击", "模拟" ], ed = [ "产品预研阶段", "上线营销阶段", "产品测试阶段", "长线运营阶段" ], eo = () => ({
        ...
        id: "none",
        name: "暂不启用",
        description: "暂不接入广告变现平台，组合包仍默认包含广告能力，可稍后在运营配置中开启。"
    }, {
        id: "admob",
        name: "Google AdMob",
    ...
    let loginPlatformParameterMatrix = {
        guest: {
            iOS: [],
            Android: []
        },
        ...
        google: {
            iOS: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("scheme", "Scheme") ],
            Android: [ createLoginParameter("clientId", "Client ID") ]
        },
        facebook: {
            iOS: [ createLoginParameter("name", "Name"), createLoginParameter("clientId", "Client ID"), createLoginParameter("scheme", "Scheme"), createLoginParameter("secret", "Secret", !0) ],
            Android: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("scheme", "Scheme"), createLoginParameter("secret", "Secret", !0) ]
        },
        twitter: {
            iOS: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("scheme", "Scheme"), createLoginParameter("redirect", "Redirect") ],
            Android: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("scheme", "Scheme"), createLoginParameter("redirect", "Redirect") ]
        },
        snapchat: {
            iOS: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("scheme", "Scheme"), createLoginParameter("redirect", "Redirect") ],
            Android: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("redirect", "Redirect") ]
        },
        line: {
            iOS: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("scheme", "Scheme") ],
            Android: [ createLoginParameter("clientId", "Client ID") ]
        ...
        naver: {
            iOS: [ createLoginParameter("name", "Name"), createLoginParameter("clientId", "Client ID"), createLoginParameter("secret", "Secret", !0), createLoginParameter("scheme", "Scheme") ],
            Android: [ createLoginParameter("name", "Name"), createLoginParameter("clientId", "Client ID"), createLoginParameter("secret", "Secret", !0) ]
        },
        kakao: {
            iOS: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("scheme", "Scheme") ],
            Android: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("scheme", "Scheme") ]
        },
        tiktok: {
            iOS: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("scheme", "Scheme"), createLoginParameter("redirect", "Redirect") ],
            Android: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("scheme", "Scheme"), createLoginParameter("redirect", "Redirect") ]
        ...
        discord: {
            iOS: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("secret", "Secret", !0), createLoginParameter("redirect", "Redirect") ],
            Android: [ createLoginParameter("clientId", "Client ID"), createLoginParameter("secret", "Secret", !0), createLoginParameter("redirect", "Redirect") ]
        }
    };
    function getLoginPlatformParameters(e, platform) {
        return loginPlatformParameterMatrix[e?.id]?.[platform] || [];
    }
    function createDefaultLoginPlatformValue(e, platform, field) {
        let platformKey = platform.toLowerCase();
        return "redirect" === field.key ? `https://api.demo-game.com/login/${e.id}/${platformKey}` : "scheme" === field.key ? `meetgames.${e.id}.${platformKey}` : "name" === field.key ? `${e.displayName} Demo` : "secret" === field.key ? `demo_${e.id}_${platformKey}_secret` : `${e.id}_${platformKey}_client_id`;
    }
    function createDefaultLoginValues(e) {
        return Object.fromEntries([ "Android", "iOS" ].map(platform => [ platform, Object.fromEntries(getLoginPlatformParameters(e, platform).map(field => [ field.key, createDefaultLoginPlatformValue(e, platform, field) ])) ]));
    }
    function getLoginPlatformValue(e, platform, key) {
        return e?.[platform]?.[key] || "";
    }
    ...
    function eM({storeId: e, size: n = 22}) {
        if (!e$(e)) return null;
        let s = e.includes("app-store") ? "apple" : e.includes("google") ? "google" : "xiaomi";
        return (0, a.jsx)("span", {
    ...
    function eR(e, a = {}) {
        ...
        let n = eD(e.selected).filter(e => G.some(a => a.id === e));
        return !!n.some(e => "guest" !== e);
    }
    function eG(e = {}) {
        let a = e.channels || [], n = String(e.deliveryUrl || "").trim();
        return a.length > 0 && a.every(a => !String(e.packageNames?.[a] || "").trim() || !et(a, e.packageNames?.[a])) && a.every(a => Z(a, e.channelPaymentConfigs?.[a])) && (!n || /^https?:\/\/[^\s]+$/i.test(n));
    }
    ...
    function eF(e) {
        let a = e.feedbackTypes || [], n = e.faqLanguages || [], s = e.faqGroups || [], l = e.knowledgeItems || [], i = a.length > 0, t = !!String(e.faqBackground || "").trim() || n.length > 0 || s.length > 0, r = !!String(e.botName || "").trim() || !!String(e.fallbackText || "").trim() || l.length > 0;
        return (!i || a.every(e => e.name.trim() && e.description.trim())) && (!t || n.length > 0 && s.length > 0 && s.every(e => e.name.trim())) && (!r || String(e.botName || "").trim() && String(e.fallbackText || "").trim() && l.length > 0 && l.every(e => e.question.trim()));
    }
    function e_(e) {
        let a = e.selected || [];
        return !(a.includes("appsflyer") && a.includes("adjust")) && (!a.length || a.every(a => F.find(e => e.id === a).params.every(n => String(e.values[a]?.[n.key] || "").trim())));
    }
    function eB(e) {
        let a = String(e || "").trim();
    ...
    function eV(e = {}) {
        ...
        return "none" === a || !(![ "admob", "applovin-max" ].includes(a) || eB(e.admobAppId)) && ("applovin-max" !== a || !!String(e.maxSdkKey || "").trim());
    }
    function eX(e, a = {}) {
        let n = e.groups || [];
    ...
    function eW(e) {
        let a = String(e.ageThreshold || "").trim(), n = Number(a), s = [ e.kwsClientId, e.kwsClientSecret, e.kwsRedirect ].some(e => String(e || "").trim());
        return (!a || Number.isInteger(n) && n >= 1 && n <= 18) && (!s || String(e.kwsClientId || "").trim() && String(e.kwsClientSecret || "").trim() && /^https?:\/\/[^\s]+$/i.test(String(e.kwsRedirect || "").trim()));
    }
    ...
    function eY({label: e, value: n, onChange: s, helper: l, required: i, type: t = "text", placeholder: r, action: d, error: o}) {
        return (0, a.jsxs)("label", {
            className: `mgp-field ${o ? "has-error" : ""}`,
            children: [ (0, a.jsxs)("span", {
    ...
    function e9({config: e, releaseConfig: s, onChange: l, onOpenChooser: i, showErrors: t}) {
        let [r, d] = (0, n.useState)({}), [loginDeleteTarget, setLoginDeleteTarget] = (0, n.useState)(null), o = eD(e.selected).map(e => G.find(a => a.id === e)).filter(Boolean), p = e.selected?.includes("guest"), h = o.some(e => "guest" !== e.id), selectedPlatforms = Array.from(new Set((s.channels || []).map(e => e$(e)?.platform).filter(e => "Android" === e || "iOS" === e)));
        return (0, a.jsxs)("div", {
            ...
            children: [ (0, a.jsx)(e7, {
                ...
                children: [ o.length ? (0, a.jsxs)("div", {
                    ...
                    let o = selectedPlatforms.map(platform => {
                        let params = getLoginPlatformParameters(n, platform), filled = params.filter(a => String(getLoginPlatformValue(e.values[n.id], platform, a.key)).trim()).length, complete = !params.length || filled === params.length, stateKey = `${n.id}-${platform}`, expanded = !!params.length && !!r[stateKey], detailsId = `login-params-${n.id}-${platform.toLowerCase()}`;
                        return {
                            platform: platform,
                            params: params,
                            filled: filled,
                    ...
                    let parameterPlatforms = o.filter(e => e.hasParams), p = parameterPlatforms.length > 0, u = !p || parameterPlatforms.some(e => e.complete), g = !1;
                    o = o.map(e => ({
                        ...e,
                        hasError: g && e.hasParams && !e.complete
                    }));
                    parameterPlatforms = o.filter(e => e.hasParams);
                    let x = o.filter(e => e.expanded), totalFilled = parameterPlatforms.reduce((e, a) => e + a.filled, 0), totalParams = parameterPlatforms.reduce((e, a) => e + a.params.length, 0), anyComplete = parameterPlatforms.some(e => e.complete), y = `login-required-${n.id}`;
                    return (0, a.jsxs)("div", {
                        ...
                        children: [ (0, a.jsx)("span", {
                            ...
                            role: "group",
                            "aria-label": `${n.displayName}平台参数`,
                            children: p ? (0, a.jsxs)("button", {
                                type: "button",
                                className: `mgp-login-platform-toggle mgp-login-platform-summary ${anyComplete ? "complete" : ""}`,
                                "aria-expanded": x.length > 0,
                                "aria-controls": parameterPlatforms.map(e => e.detailsId).join(" "),
                                "aria-label": `${x.length ? "收起" : "展开"}${n.displayName}参数`,
                                onClick: () => d(e => ({
                                    ...e,
                                    ...Object.fromEntries(parameterPlatforms.map(e => [ e.stateKey, 0 === x.length ]))
                                })),
                                children: [ (0, a.jsx)("span", {
                                    className: "mgp-login-platform-status",
                                    children: anyComplete ? (0, a.jsxs)(a.Fragment, {
                            ...
                            children: [ [ "guest", "email", "apple" ].includes(n.id) ? null : (0, a.jsxs)("a", {
                                ...
                                children: [ (0, a.jsx)("header", {
                                    children: (0, a.jsxs)("strong", {
                                        children: [ p.platform, " 参数" ]
                                    })
                                }), (0, a.jsx)("div", {
                                    className: "mgp-inline-param-grid",
                                    children: p.params.map(s => {
                                        let r = getLoginPlatformValue(e.values[n.id], p.platform, s.key);
                                        return (0, a.jsxs)("label", {
                                            children: [ (0, a.jsx)("span", {
                                                children: s.label
                                            }), (0, a.jsx)("input", {
                                                ...
                                                value: r,
                                                "aria-label": `${n.displayName} ${p.platform} ${s.label}`,
                                                "aria-invalid": "false",
                                                onChange: a => l({
                                                    values: {
                                                        ...e.values,
    ...
    function an({config: e = {}, onChange: n, showErrors: s}) {
        let l = e.provider || "none", i = "none" !== l, t = R.find(e => "advertising" === e.id)?.help, d = s && i ? eB(e.admobAppId) : "", o = s && "applovin-max" === l && !String(e.maxSdkKey || "").trim() ? "请填写 MAX SDK Key" : "";
        return (0, a.jsxs)("div", {
            ...
            children: [ (0, a.jsx)(e7, {
                ...
                children: [ (0, a.jsx)("div", {
                    ...
                    }), "applovin-max" === l ? (0, a.jsxs)("section", {
    ...
    function al({config: e, onChange: n, showErrors: s}) {
        let l = String(e.ageThreshold || "").trim(), i = l && (!Number.isInteger(Number(l)) || Number(l) < 1 || Number(l) > 18) ? "请输入 1-18 之间的整数" : "", t = String(e.kwsRedirect || "").trim(), r = t && !/^https?:\/\/[^\s]+$/i.test(t) ? "请输入以 http:// 或 https:// 开头的有效地址" : "";
        return (0, a.jsxs)("div", {
            ...
            children: [ (0, a.jsx)(e7, {
                ...
                children: [ (0, a.jsxs)("div", {
                    ...
                    children: "需要启用对应能力时，可在运营配置中开启。"
                }), (0, a.jsxs)("div", {
                    className: "mgp-form-grid four",
                    children: [ (0, a.jsx)(eY, {
                        label: "年龄阈值",
    ...
    function ar({config: e = {}, onChange: s, showErrors: l}) {
        let i = e.channels || [], t = e.channelPaymentConfigs || {}, r = e.packageNames || {}, d = e.deliveryUrl || "", [o, c] = (0, 
        n.useState)(!1), m = l && d.trim() && !/^https?:\/\/[^\s]+$/i.test(d.trim()) ? "请输入以 http:// 或 https:// 开头的有效地址" : "";
        return (0, a.jsxs)("div", {
            ...
            children: [ (0, a.jsx)(e7, {
                ...
                type: "button",
                className: "mgp-other-payment-link",
                onClick: () => c(!0),
                children: "其他支付方式？"
            }), o ? (0, a.jsx)(at, {
                onClose: () => c(!1)
                    ...
                    return n ? (0, a.jsxs)("section", {
                        ...
                        children: [ (0, a.jsxs)("header", {
                            children: [ (0, a.jsxs)("span", {
                                ...
                                children: [ n.platform, " · ", s.packageNames?.[e] || "未填写包名" ]
                            }) ]
                        }), (0, a.jsx)(ap, {
                            selected: l,
                            onToggle: a => {
    ...
    function ao({gameName: e, gameProfile: s, packages: l, config: i, onStartNew: t, onResume: r, onDownload: d, onEnterOperations: o, onDelete: c, toast: m}) {
                ...
                children: [ (0, a.jsx)("header", {
                    children: (0, a.jsxs)("div", {
                        children: [ (0, a.jsx)("h2", {
                            ...
                            children: "按发行渠道维护 SDK 组合包，可随时修改、查看详情或下载。"
                        }) ]
                    })
                }), (0, a.jsxs)("div", {
                        ...
                        return (0, a.jsxs)("div", {
                            ...
                            children: [ (0, a.jsxs)("span", {
                                ...
                                children: [ (0, a.jsx)("button", {
                                    type: "button",
                                    className: "mgp-text-action",
                                    "aria-label": `修改${l?.name || s}SDK组合包`,
                                    onClick: () => r(n),
                                    children: "修改"
                                }), (0, a.jsx)("button", {
                                    type: "button",
                                    className: "mgp-text-action",
                                    "aria-label": `查看${l?.name || s}SDK组合包详情`,
                                    onClick: () => h(n.id),
                                    children: "详情"
                                }), n.configurationComplete ? (0, a.jsx)("button", {
                                    type: "button",
                                    className: "mgp-text-action",
                                    "aria-label": `下载${l?.name || s}SDK组合包 ZIP`,
                                    onClick: () => {
                                        n.configurationComplete ? d(n) : m("当前 SDK 组合包配置尚未完成，暂时无法下载", "error");
                                    },
                                    children: "下载"
                ...
                children: (0, a.jsxs)("section", {
                    ...
                    children: [ (0, a.jsxs)("header", {
                        ...
                        children: [ (0, a.jsx)("span", {
                            ...
                            children: [ e$(j.storeId)?.platform || "未配置", " ·", " ", e$(j.storeId)?.name || "未配置渠道" ]
                        }) ]
                    }), (0, a.jsxs)("footer", {
                        children: [ (0, a.jsx)("button", {
                            type: "button",
    ...
    function ac({gameName: e, setGameName: l, games: i, gameProfiles: t, onAddGame: r, onUpdateGame: d, config: c, setConfig: p, activeStep: h, setActiveStep: u, validMap: g, completeMap: x, onStepSaved: j, onStepsDirty: b, toast: f, availableChannels: y, mode: v, packages: k, onModeChange: N, onDownloadPackage: C, onEnterOperations: S, onDeletePackage: w}) {
        let [A, $] = (0, n.useState)(null), [I, D] = (0, n.useState)(!1), [E, P] = (0, n.useState)("create"), [O, M] = (0, 
        n.useState)(eo), [L, U] = (0, n.useState)(null), _ = R[h], B = Object.values(x).filter(Boolean).length, V = O.name.trim() && O.type && O.stage, X = (e, a) => {
            b([ e ]), p(n => ({
                ...n,
                [e]: {
                    ...n[e],
        ...
        }, H = e => "login" === e ? eD(c.login?.selected).some(e => "guest" !== e) : "agreement" === e ? (c.agreement?.groups || []).length > 0 : "compliance" === e ? [ "ageThreshold", "kwsClientId", "kwsClientSecret", "kwsRedirect" ].some(e => String(c.compliance?.[e] || "").trim()) : "data" === e ? (c.data?.selected || []).length > 0 : "advertising" === e ? !!c.advertising?.provider && "none" !== c.advertising.provider : "support" === e && (!!String(c.support?.onlineName || "").trim() || (c.support?.feedbackTypes || []).length > 0 || !!String(c.support?.faqBackground || "").trim() || (c.support?.faqGroups || []).length > 0 || !!String(c.support?.botName || "").trim() || (c.support?.knowledgeItems || []).length > 0);
        return (0, a.jsxs)("div", {
            ...
            children: [ (0, a.jsxs)("section", {
                ...
                children: [ (0, a.jsx)("div", {
                    ...
                    children: "管理已配置的 SDK 组合包，或新增组合包进入配置页面。"
                }) : null ]
            }), "home" === v ? (0, a.jsx)(ao, {
                gameName: e,
                gameProfile: t[e],
                ...
                children: [ (0, a.jsxs)("div", {
                    ...
                    children: [ (0, a.jsx)("div", {
                        ...
                        "aria-label": "SDK 配置模块",
                        children: R.filter(e => "release" !== e.id).map(e => {
                            let n = R.findIndex(a => a.id === e.id), s = h === n, i = e.icon;
                            return (0, a.jsxs)("button", {
                                type: "button",
                                id: `config-tab-${e.id}`,
                                className: `mgp-config-card ${s ? "active" : ""}`,
                                onClick: () => {
                                    u(n), U(null);
                                },
                                "aria-label": e.title,
                    ...
                    className: `mgp-config-panel mgp-foundation-panel ${"release" === _.id ? "mgp-release-config-panel" : "mgp-config-card-modal"}`,
                    role: "release" === _.id ? "region" : "dialog",
                    "aria-modal": "release" === _.id ? void 0 : "true",
                    "aria-labelledby": `config-tab-${_.id}`,
                    "aria-label": _.title,
                    children: [ "release" !== _.id ? (0, a.jsxs)("header", {
                        ...
                        children: [ (0, a.jsxs)("div", {
                            ...
                            onClick: () => {
                                H(_.id) && g[_.id] && j(_.id), U(null), u(0);
                            },
                            children: (0, a.jsx)(T.X, {
                                size: 18
                            })
                        }) ]
                    }) : null, "release" === _.id ? (0, a.jsx)(ar, {
                        config: c.release,
                        onChange: e => {
                            b([ "release", "login" ]), p(a => ({
                                ...a,
                        ...
                        children: [ (0, a.jsxs)("button", {
                            ...
                            onClick: () => {
                                U(null), "release" === _.id ? N("home") : u(0);
                            },
                            children: [ (0, a.jsx)(s.ArrowLeft, {
                                size: 16
                            }), "release" === _.id ? "返回首页" : "关闭" ]
                        }), (0, a.jsxs)("button", {
                            type: "button",
                            className: "mgp-button primary",
                            onClick: () => {
                                if ("release" === _.id) {
                                    if (!g.release) {
                                        U("release"), f("请先选择发行渠道并补全渠道支付参数", "error");
                                        return;
                                    }
                                    U(null), j("release"), f("SDK 组合包已保存"), N("home");
                                    return;
                                }
                                if (H(_.id) && !g[_.id]) {
                                ...
                                U(null), H(_.id) ? j(_.id) : b([ _.id ]), u(0);
                            },
                            children: [ (0, a.jsx)(z.Save, {
                                size: 16
                            }), "release" === _.id ? "保存组合包" : "完成" ]
                        }) ]
                    }) ]
                }) ]
            }), I ? (0, a.jsx)("div", {
    ...
    function am({selected: e, paymentConfigs: s, packageNames: l, onSelect: i, onRemove: t, onPackageNameChange: r, onPaymentChange: d, showErrors: o = !1}) {
        let [p, h] = (0, n.useState)(B[0].platform), [u, g] = (0, n.useState)({}), x = B.find(e => e.platform === p) || B[0], j = (e, a) => {
            g(n => ({
                ...n,
                [e]: !a
            }));
        ...
        return (0, a.jsxs)("div", {
            className: `mgp-channel-picker ${o && !e.length ? "has-error" : ""}`,
            children: [ e.length ? (0, a.jsxs)("div", {
                ...
                children: [ (0, a.jsxs)("div", {
                    ...
                    let n = e$(e);
                    if (!n) return null;
                    let i = Q(n.id), p = s[n.id] || J(n.id), h = Z(n.id, p), g = l?.[n.id] || "", x = g ? et(n.id, g) : "", b = x, f = !!g && !x, y = o && !h, v = y || !!b, k = !!b || y || !0 === u[n.id] || void 0 === u[n.id] && !h, N = i.fields.filter(e => !W(e, p.official?.[e[0]])).length;
                    return (0, a.jsxs)("div", {
                        ...
                        children: [ (0, a.jsxs)("div", {
                            ...
                            children: [ (0, a.jsxs)("span", {
                                ...
                                type: "button",
                                className: `mgp-package-config-summary ${f ? "complete" : b ? "invalid" : ""}`,
                                "aria-label": `${n.name}包名配置`,
                                "aria-expanded": k,
                                "aria-controls": `channel-config-details-${n.id}`,
                                "aria-invalid": !!b,
                                onClick: () => j(n.id, k),
                            ...
                            children: [ k ? (0, a.jsxs)("label", {
                                id: `package-name-fields-${n.id}`,
                                className: `mgp-channel-package-field ${b ? "has-error" : ""}`,
                                children: [ (0, a.jsxs)("span", {
                                    children: [ n.name, "包名（可选）" ]
                                }), (0, a.jsx)("input", {
                                    type: "text",
                                    value: g,
                                    placeholder: "com.company.game",
                                    "aria-label": `${n.name}包名`,
                                    "aria-invalid": !!b,
                                    onChange: e => r(n.id, e.target.value.trimStart())
                                }), b ? (0, a.jsx)("small", {
                                    className: "mgp-field-error",
                                    children: b
                                }) : (0, a.jsx)("small", {
                                    className: "mgp-field-helper",
                                    children: ei(n.id)
                                }) ]
                            }) : null, k ? (0, a.jsx)("div", {
                ...
                className: "mgp-channel-picker-fields",
                children: [ (0, a.jsx)(eL, {
                    groups: B,
                    selected: p,
                    onSelect: h
            ...
            }), o && !e.length ? (0, a.jsx)(e2, {
                children: "请至少选择一个平台和发行渠道"
            }) : null ]
        });
    }
    ...
    function ab({item: e, configuredLoginMethodIds: s, configuredAgreementGroups: l, onSave: i, onClose: t, onGoLoginConfig: r, onGoAgreementConfig: d, toast: o}) {
        ...
        return (0, a.jsx)("div", {
            ...
            children: (0, a.jsxs)("aside", {
                ...
                role: "dialog",
                "aria-modal": "true",
                "aria-label": `自定义配置 ${e.packageName}`,
                children: [ (0, a.jsxs)("header", {
                    className: "mgp-sdk-drawer-header",
                    children: [ (0, a.jsxs)("div", {
                        children: [ (0, a.jsx)("span", {
                        ...
                        children: [ (0, a.jsx)("header", {
                            ...
                            children: (0, a.jsxs)("div", {
                                ...
                                children: [ (0, a.jsxs)("div", {
                                    ...
                                    onGoConfig: () => ei(r),
                                    disabled: !V,
                                    disabledReason: B ? "当前国家或地区已关闭登录SDK，开启后可继续编辑；原选择与排序会保留。" : "配置中心未将登录SDK加入当前渠道包，登录方式选择与排序暂不可编辑。"
                                }), (0, a.jsx)(au, {
                                    groups: g,
                        ...
                        children: [ (0, a.jsx)("header", {
                            children: (0, a.jsxs)("div", {
                                children: [ (0, a.jsx)("h3", {
                                    ...
                                    children: "可维护当前国家或地区的全部 SDK 能力，并配置渠道包运行开关。"
                                }) ]
                            })
                        }), b.length ? (0, a.jsx)(ag, {
                            modules: F,
                            ...
                            children: [ (0, a.jsxs)("div", {
                                ...
                                children: [ (0, a.jsx)("dt", {
                                    ...
                                    children: [ (0, a.jsx)(eM, {
                                        ...
                                        children: [ x?.name || u, " · ", x?.platform || "未配置平台" ]
                                    }) ]
                                }) ]
                            }), (0, a.jsxs)("div", {
                                children: [ (0, a.jsx)("dt", {
                                ...
                                children: [ (0, a.jsx)("dt", {
                                    ...
                                    children: (0, a.jsx)("span", {
                                        className: `mgp-status-pill ${Z(u, j) ? "complete" : ""}`,
                                        children: Z(u, j) ? "配置完整" : "待完善"
                                    })
                                }) ]
                            }) ]
                        }) ]
                        ...
                        children: [ (0, a.jsx)("h3", {
                            ...
                            children: [ (0, a.jsxs)("div", {
                                ...
                                children: [ (0, a.jsx)("dt", {
                                    ...
                                    children: complianceConfig.kwsClientSecret ? "••••••••" : "未填写"
                                }) ]
                            }), (0, a.jsxs)("div", {
                                children: [ (0, a.jsx)("dt", {
    ...
    function ay({gameName: e, games: s, onGameChange: l, packages: i, configuredLoginMethodIds: t, configuredAgreementGroups: r, configuredCompliance: configuredCompliance, configuredDataPlatformIds: d, configuredAdvertising: o, configuredSupport: configuredSupport, gameProfile: c, initialEditingPackageId: p, onInitialEditingHandled: h, onSave: u, onGoLoginConfig: g, onGoAgreementConfig: x, toast: j}) {
        ...
        return (0, n.useEffect)(() => {
            ...
            children: [ (0, a.jsx)("section", {
                ...
                children: [ (0, a.jsx)("header", {
                    children: (0, a.jsxs)("div", {
                        children: [ (0, a.jsx)("h2", {
                            ...
                            children: "运营配置直接承接配置中心生成的渠道包，用于维护发行范围、区域化策略、SDK 能力启停与运行开关。"
                        }) ]
                    })
                }), (0, a.jsxs)("div", {
                    ...
                    children: [ (0, a.jsxs)("div", {
                        ...
                        let s = n.storeId || n.channels?.[0], l = e$(s), i = eK(n).map(e => eq(e)?.title).filter(Boolean), t = (n.countries || []).map(e => eE(e)?.name).filter(Boolean);
                        return (0, a.jsxs)("div", {
                            ...
                            children: [ (0, a.jsxs)("span", {
                                ...
                                className: t.length ? "" : "mgp-sdk-plan-pending",
                                title: t.join("、"),
                                children: t.length ? t.join("、") : "待配置"
                            }), (0, a.jsx)("span", {
                                title: i.join("、"),
                                children: i.join("、")
                            }), (0, a.jsxs)("span", {
                        ...
                        children: "当前游戏暂无渠道包模板，请先在配置中心选择发行渠道并补全渠道支付参数。"
                    }) ]
                }) ]
            }), N ? (0, a.jsx)(ab, {
                item: N,
                configuredLoginMethodIds: t,
                configuredAgreementGroups: r,
                onSave: (e, a) => {
                    u(e, a), f(null);
                },
                onClose: () => f(null),
                ...
                configuredLoginMethodIds: t,
                configuredAgreementGroups: r,
                configuredCompliance: configuredCompliance,
                configuredDataPlatformIds: d,
                configuredAdvertising: o,
    ...
    function ak({gameName: e, records: n}) {
        return (0, a.jsxs)("div", {
            ...
            children: [ (0, a.jsx)(eZ, {
                ...
                children: [ [ "本月生成SDK包", "12", "较上月 +20%", E.PackageCheck, "purple" ], [ "今日活跃用户", "128,460", "较昨日 +8.4%", L.UserRound, "blue" ], [ "登录成功率", "99.32%", "稳定运行", $.LogIn, "green" ], [ "支付成功率", "96.84%", "较昨日 +0.7%", u.CreditCard, "orange" ] ].map(([e, n, s, l, i]) => (0, 
                a.jsxs)("article", {
    ...
    e.s([ "default", 0, function() {
        ...
        }), [y, v] = (0, n.useState)(0), [k, N] = (0, n.useState)({
            release: {
                channels: [ "android-google" ],
                channelPaymentConfigs: {
                    "android-google": J("android-google", !0)
                },
                packageNames: {
                    "android-google": "com.demo.legend.global"
                },
                deliveryUrl: ""
            },
            login: {
        ...
        n.useState)(null), H = e => JSON.parse(JSON.stringify(e)), Q = (0, n.useRef)(null);
        ...
        })), [ k ]), Z = b[m] || [], Y = (0, n.useMemo)(() => Object.fromEntries(R.map(e => [ e.id, Z.includes(e.id) && W[e.id] ])), [ Z, W ]), ee = Object.values(Y).filter(Boolean).length, ea = (0, 
        n.useMemo)(() => {
            let e = C[m] || {};
            return (k.release?.channels || []).map(a => {
                let n = e[a] || {}, s = ec.map(e => e.id), l = {
                    ...aw,
                    ...n.sdkSwitches || {},
                    ...n.switches || {}
                ...
                return {
                    ...
                    storeId: a,
                    channels: [ a ],
                    packageName: String(k.release?.packageNames?.[a] || "").trim(),
                    includedCapabilities: s,
                    modules: s,
                    channelPaymentConfigs: {
                        [a]: k.release?.channelPaymentConfigs?.[a]
                    },
                    paymentConfigured: [ a ],
        ...
        }, [ k.capabilities, k.release, m, C ]), en = (0, n.useMemo)(() => ea.map(e => ({
            ...e,
            configurationComplete: function(e = {}, a = "") {
                if (!a) return !1;
                return eG({
                    ...e.release || {},
                    channels: [ a ],
                    packageNames: {
                        [a]: e.release?.packageNames?.[a] || ""
                    },
                    channelPaymentConfigs: {
                        [a]: e.release?.channelPaymentConfigs?.[a]
                    }
                });
            }(k, e.storeId)
            ...
            return e.release = {
                ...
                packageNames: {},
                deliveryUrl: ""
            }, e.login.selected = [ "guest" ], e.support = {
                onlineEnabled: !0,
                feedbackEnabled: !0,
                faqEnabled: !0,
                smartEnabled: !0,
        ...
        return ed = "config" === e ? (0, a.jsx)(ac, {
            ...
            onAddGame: e => {
                ...
                })), N(n), p(a), v(0), el("游戏已添加，可开始独立配置"), !0;
            },
            onUpdateGame: (e, a) => {
                let n = a.name.trim();
